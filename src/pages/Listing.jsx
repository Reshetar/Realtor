  ...
  return (
    <main>
        ...
        {shareLinkCopy && (
          ...
          bg-white z-10 p-2">Link Copy</p>
        )}

        <div className="flex flex-col md:flex-row max-w-6xl lg:mx-auto m-4 p-4 rounded-lg bg-white shadow-lg
        lg:space-x-5">
          <div className="w-full">
            ...
            <div className="flex justify-start items-center space-x-4 w-[75%]">
              ...
              {listing.offer && (
                <p className="w-full max-w-[200px] bg-green-800 rounded-md p-1 text-white 
            ...
            <ul className="flex items-center space-x-2 lg:space-x-10 text-sm font-semibold mb-6">
                ...
                <li className="flex  items-center whitespace-nowrap">
                  ...
                  {+listing.bathrooms > 1 ? `${listing.barhrooms} Baths` : "1 Bath"}
                </li>
                <li className="flex  items-center whitespace-nowrap">
